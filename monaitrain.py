    ...
    for epoch in range(num_epochs):
        ...
        if (epoch + 1) % val_interval == 0:
            ...
            with torch.no_grad():
                ...
                writer.add_scalar("val_mean_precision", precision_metric, epoch + 1)
                writer.add_scalar("val_mean_recall", recall_metric, epoch + 1)
                writer.add_scalar("val_mean_f1_score", f1_score_metric, epoch + 1)
                writer.add_scalar("val_mean_iou", iou_metric, epoch + 1)
